...
export class Navbar {
  ...
  routeItems: { label: string; path?: string; children?: { label: string; path: string }[] }[] = [
    ...
    { label: 'Sacraments', children: [
      { label: 'Baptism', path: '/sacraments/baptism' },
      { label: 'Holy first communion', path: '/sacraments/holy-first-communion' },
      { label: 'Confirmation', path: '/sacraments/confirmation' },
      { label: 'Wedding', path: '/sacraments/wedding' },
      { label: 'Annointing of the sick', path: '/sacraments/annointing-of-the-sick' },
      { label: 'Consecration', path: '/sacraments/consecration'}
    ]},
    { label: 'Activities', children: [
      { label: 'Upcoming Activities', path: '/activities/upcoming-activities' },
      { label: 'Celebrations', path: '/activities/celebrations' },
      { label: 'Live streaming celebrations', path: '/activities/live-streaming-celebrations' },
      { label: 'Bible Course', path: '/activities/bible-course' },

    ]},
    {label: 'Join Us', children: [
